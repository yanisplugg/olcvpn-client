...
assert.deepEqual(v, {
  name: "Berlin", scheme: "https", host: "vpn.example.com", port: 8443,
  user: "11111111-2222-3333-4444-555555555555", pass: "11111111-2222-3333-4444-555555555555",
});

assert.equal(parseLink("vless://uuid@h.net:443?proxyPort=9443#x").port, 9443, "link port wins");
assert.equal(parseLink("vless://uuid@h.net:443#x", 8080).port, 8080, "settings port is the default");
